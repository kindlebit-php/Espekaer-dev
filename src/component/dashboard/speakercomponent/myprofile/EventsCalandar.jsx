      ...
      <div className="my-profile-page">
        ...
        <div className="mp-right-panel" id="generate-event">
          ...
          <div id="Calendar">
            ...
            />
            {/* Add event modal */}
            {/* <Modal show={openSlot} onHide={handleClose} centered>
              <Modal.Header closeButton>{`Book an appointment on ${moment(
                start
              ).format("MMMM Do YYYY")}`}</Modal.Header>
