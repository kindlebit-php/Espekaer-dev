        ...
        <div className="my-profile-page">
          ...
          <div className="mp-right-panel" id="mp-change-password">
            ...
            <form className="row" action="">
              ...
              {(allPassword.newPassword !== allPassword.confirmPassword && allPassword.confirmPassword?.length>0 && allPassword.newPassword?.length>0) ? <span className="ref-error">Password doesn't match</span>:""}
...
export default OrgnzrChangePassword;
